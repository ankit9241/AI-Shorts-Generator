...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    AWS_ACCESS_KEY_ID: process.env.PODSNAP_AWS_ACCESS_KEY_ID || process.env.AWS_ACCESS_KEY_ID,
    AWS_SECRET_ACCESS_KEY: process.env.PODSNAP_AWS_SECRET_ACCESS_KEY || process.env.AWS_SECRET_ACCESS_KEY,
    AWS_REGION: process.env.PODSNAP_AWS_REGION || process.env.AWS_REGION,

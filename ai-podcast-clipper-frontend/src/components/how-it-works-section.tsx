...
const steps = [
  {
    ...
    code: `import { PodSnap } from '@podsnap/sdk'

// Upload horizontal podcast
const video = await PodSnap.upload('episode_42.mp4', {
  maxSize: '500MB'
})`,
  },
  {
    ...
    code: `// Transcribe and detect active speakers
const pipeline = await video.process({
  transcribe: 'whisperx',
  momentDetection: 'gemini-2.5-flash',
  crop: 'active-speaker-9-16'
})`,
  },
  {
    number: "III",
    ...
    code: `// Export generated clips
const clips = await pipeline.getClips()

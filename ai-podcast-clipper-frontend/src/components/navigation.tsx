...
export function Navigation() {
  ...
  const btnBase = "inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-all disabled:pointer-events-none disabled:opacity-50 shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2";
      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link
              href="/signup"
              className={`${btnBase} bg-foreground hover:bg-foreground/90 text-background rounded-full transition-all duration-500 text-sm ${
      ...
      >
        <div className="flex flex-col h-full px-8 pt-6 pb-8">
          ...
          >
            <Link 
              href="/login"
              className={`${btnBase} border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 flex-1 rounded-full h-14 text-base`}
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Sign in
            </Link>
            <Link 
              href="/signup"
              className={`${btnBase} flex-1 bg-foreground text-background rounded-full h-14 text-base hover:bg-foreground/90`}
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Get Started
            </Link>
